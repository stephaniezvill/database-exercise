...
values ('Bob Marley and the Wailers','Legend: The Best of Bob Marley & The Wailers','1984', '30', 'Reggae'),
       ...
       ('Micheal Jackson', 'Bad', '1987', '35', 'Pop, rhythm and blues, funk and rock'),
       ('Led Zeppelin', 'Led Zeppelin IV', '1971', '37', 'Hard rock, heavy metal, folk rock'),
       ('Bee Gees / Various artist', 'Saturday Night Fever', '1977', '40', 'Disco'),
       ...
       ('Pink FLoyed', 'The Dark Side of the Moon', '1973', '45', 'Progressive rock'),
